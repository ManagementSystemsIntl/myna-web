...
class QuestionOptionsControllerTest < ActionController::TestCase
  ...
  test "should create question_option" do
    assert_difference('QuestionOption.count') do
      post :create, question_option: { name: @question_option.name, question_type_id: @question_option.question_type_id, type: @question_option.type }
    end
  ...
  test "should update question_option" do
    patch :update, id: @question_option, question_option: { name: @question_option.name, question_type_id: @question_option.question_type_id, type: @question_option.type }
    assert_redirected_to question_option_path(assigns(:question_option))
  end
